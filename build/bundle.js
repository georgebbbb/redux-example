...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appComponentsTodoAppReactJs = __webpack_require__(175);

	var _appComponentsTodoAppReactJs2 = _interopRequireDefault(_appComponentsTodoAppReactJs);

	// Action:
	var increaseAction = { type: 'increase' };
	var discreaseAction = { type: 'discrease' };
	// Reducer:
	...
	var App = (0, _reactRedux.connect)(function (state) {
	  ...
	  return {
	    ...
	    ondiscreaseClick: function ondiscreaseClick() {
	      return dispatch(discreaseAction);
	    }
	  };
	})(_appComponentsTodoAppReactJs2['default']);
	...
	var TodoApp = (function (_React$Component) {
	  ...
	  _createClass(TodoApp, [{
	    ...
	    value: function render() {
	      ...
	      var ondiscreaseClick = _props.ondiscreaseClick;
	      var haha = _props.haha;
